...
def brat2viz():
    ...
    if selected_vis == 'ann_text':
        ...
        return render_template('index.html', drs_files=drs_files, selected_drs=drs_file, selected_vis=vis, text=ann_text)

    elif selected_vis == 'drs_text':
        vis = 'drs_text'
        with open(drs_file, 'r') as fp:
            drs_text = fp.readlines()
        return render_template('index.html', drs_files=drs_files, selected_drs=drs_file, selected_vis=vis, text=drs_text)
        ...
        return render_template('index.html', drs_files=drs_files, selected_drs=drs_file, selected_vis=vis, actors=actors, non_ev_rels=non_ev_rels, ev_rels=ev_rels)
    ...
    # Default
        ...
        return render_template('index.html', drs_files=drs_files, selected_drs=drs_file, selected_vis=vis, text=news_text)
